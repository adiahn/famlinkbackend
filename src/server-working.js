...
app.get('/health', (req, res) => {
  res.status(200).json({
    success: true,
    message: 'FamTree API is running (Working Mode)',
...
app.get('/test', (req, res) => {
  res.status(200).json({
    success: true,
    message: 'Server is working with MongoDB Atlas!',
    timestamp: new Date().toISOString(),
...
const server = app.listen(PORT, () => {
  console.log(`🚀 FamTree API server (Working Mode) running on port ${PORT}`);
