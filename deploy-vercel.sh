...
echo ""
echo "🧪 Test endpoints:"
echo "   - Health: https://your-project-name.vercel.app/health"
echo "   - API Info: https://your-project-name.vercel.app/api"
echo "   - Test: https://your-project-name.vercel.app/test" 